...
export class MapHelperService {
  ...
  mapH3KeySelectedSubject = new BehaviorSubject<String>('');
  mapH3KeySelected$ = this.mapH3KeySelectedSubject.asObservable();
  ...
  selecteH3Key(h3Key: string): void {
    console.log('selected', h3Key);
    this.mapH3KeySelectedSubject.next(h3Key);
  }
}
